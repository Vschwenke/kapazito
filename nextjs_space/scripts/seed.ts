...
const customers = [
  { id: 'baker', name: 'Baker Hughes Inc.', shortName: 'Baker', industry: 'Energy Technology' },
  { id: 'diartis', name: 'Diartis AG', shortName: 'Diartis', industry: 'Healthcare IT' },
  { id: 'diebold', name: 'Diebold Nixdorf', shortName: 'Diebold', industry: 'Financial Technology' },
  { id: 'quoniam', name: 'Quoniam GmbH', shortName: 'Quoniam', industry: 'Asset Management' },
  { id: 'westdeutsche', name: 'Westdeutsche Wasser', shortName: 'WDW', industry: 'Utilities' },
  { id: 'vilano', name: 'Vilano Tec', shortName: 'Vilano', industry: 'Technology' },
];

const employees = [
  { id: 'anderle', firstName: 'Dennis', lastName: 'Anderle', contractType: 'Hybrid', experienceLevel: 'Senior', monthlyIncome: 6800, homeOfficePercent: 55 },
  { id: 'andonov', firstName: 'Aleksandar', lastName: 'Andonov', contractType: 'Remote', experienceLevel: 'Senior', monthlyIncome: 7200, homeOfficePercent: 90 },
  { id: 'bald', firstName: 'Markus', lastName: 'Bald', contractType: 'Hybrid', experienceLevel: 'Lead', monthlyIncome: 8500, homeOfficePercent: 60 },
  { id: 'bartoszewicz', firstName: 'Phil', lastName: 'Bartoszewicz', contractType: 'Remote', experienceLevel: 'Mid', monthlyIncome: 5500, homeOfficePercent: 85 },
  { id: 'esau', firstName: 'Benjamin', lastName: 'Esau', contractType: 'Office', experienceLevel: 'Mid', monthlyIncome: 5200, homeOfficePercent: 30 },
  { id: 'fittkau', firstName: 'Fabian', lastName: 'Fittkau', contractType: 'Remote', experienceLevel: 'Senior', monthlyIncome: 6900, homeOfficePercent: 80 },
  { id: 'froehlich', firstName: 'Fabian', lastName: 'Fr\u00f6hlich', contractType: 'Hybrid', experienceLevel: 'Mid', monthlyIncome: 5400, homeOfficePercent: 50 },
  { id: 'fuss', firstName: 'Benjamin', lastName: 'Fuss', contractType: 'Remote', experienceLevel: 'Senior', monthlyIncome: 7100, homeOfficePercent: 75 },
  { id: 'hantke', firstName: 'Moritz', lastName: 'Hantke', contractType: 'Hybrid', experienceLevel: 'Mid', monthlyIncome: 5600, homeOfficePercent: 45 },
  { id: 'harder', firstName: 'Marvin', lastName: 'Harder', contractType: 'Office', experienceLevel: 'Junior', monthlyIncome: 4200, homeOfficePercent: 20 },
  { id: 'kamin', firstName: 'Eugen', lastName: 'Kamin', contractType: 'Remote', experienceLevel: 'Senior', monthlyIncome: 7000, homeOfficePercent: 70 },
  { id: 'nachtigall', firstName: 'Marcus', lastName: 'Nachtigall', contractType: 'Hybrid', experienceLevel: 'Lead', monthlyIncome: 8200, homeOfficePercent: 65 },
  { id: 'schmidt', firstName: 'Erik', lastName: 'Schmidt', contractType: 'Remote', experienceLevel: 'Senior', monthlyIncome: 7500, homeOfficePercent: 88 },
  { id: 'teschke', firstName: 'Nico', lastName: 'Teschke', contractType: 'Hybrid', experienceLevel: 'Mid', monthlyIncome: 5300, homeOfficePercent: 55 },
  { id: 'vinkemeier', firstName: 'Sven', lastName: 'Vinkemeier', contractType: 'Office', experienceLevel: 'Senior', monthlyIncome: 6600, homeOfficePercent: 25 },
  { id: 'volkmann', firstName: 'Sven', lastName: 'Volkmann', contractType: 'Remote', experienceLevel: 'Mid', monthlyIncome: 5800, homeOfficePercent: 82 },
  { id: 'xavier', firstName: 'Cesar', lastName: 'Xavier', contractType: 'Remote', experienceLevel: 'Senior', monthlyIncome: 7400, homeOfficePercent: 92 },
  { id: 'mueller', firstName: 'Thomas', lastName: 'M\u00fcller', contractType: 'Hybrid', experienceLevel: 'Lead', monthlyIncome: 8800, homeOfficePercent: 50 },
  { id: 'weber', firstName: 'Lisa', lastName: 'Weber', contractType: 'Remote', experienceLevel: 'Senior', monthlyIncome: 7300, homeOfficePercent: 78 },
  { id: 'koch', firstName: 'Stefan', lastName: 'Koch', contractType: 'Office', experienceLevel: 'Mid', monthlyIncome: 5100, homeOfficePercent: 30 },
  { id: 'braun', firstName: 'Anna', lastName: 'Braun', contractType: 'Hybrid', experienceLevel: 'Junior', monthlyIncome: 4500, homeOfficePercent: 40 },
  { id: 'lang', firstName: 'Peter', lastName: 'Lang', contractType: 'Remote', experienceLevel: 'Senior', monthlyIncome: 6700, homeOfficePercent: 85 },
  { id: 'hoffmann', firstName: 'Julia', lastName: 'Hoffmann', contractType: 'Hybrid', experienceLevel: 'Mid', monthlyIncome: 5900, homeOfficePercent: 55 },
  { id: 'richter', firstName: 'Max', lastName: 'Richter', contractType: 'Office', experienceLevel: 'Junior', monthlyIncome: 4100, homeOfficePercent: 15 },
  { id: 'klein', firstName: 'Sarah', lastName: 'Klein', contractType: 'Remote', experienceLevel: 'Mid', monthlyIncome: 5700, homeOfficePercent: 72 },
  { id: 'berger', firstName: 'Daniel', lastName: 'Berger', contractType: 'Hybrid', experienceLevel: 'Senior', monthlyIncome: 7100, homeOfficePercent: 60 },
  { id: 'wolf', firstName: 'Michael', lastName: 'Wolf', contractType: 'Remote', experienceLevel: 'Mid', monthlyIncome: 5500, homeOfficePercent: 80 },
];

const projects = [
  { id: 'itrak-whs', name: '2026-Q1-1-iTrak WHS', customerId: 'baker', purchaseOrder: 'PO-2026-001', hourlyRate: 95, budgetHours: 2000 },
  { id: 'itrak-inf', name: '2026-Q1-2-iTrak INF', customerId: 'baker', purchaseOrder: 'PO-2026-002', hourlyRate: 93, budgetHours: 1500 },
  { id: 'diartis-vertec', name: 'Diartis Vertec Integration', customerId: 'diartis', purchaseOrder: 'PO-2026-003', hourlyRate: 90, budgetHours: 1200 },
  { id: 'diebold-ppm', name: 'Diebold PPM', customerId: 'diebold', purchaseOrder: 'PO-2026-004', hourlyRate: 98, budgetHours: 1800 },
  { id: 'diebold-agile', name: 'Diebold AgileOne', customerId: 'diebold', purchaseOrder: 'PO-2026-005', hourlyRate: 95, budgetHours: 1600 },
  { id: 'quoniam-dev', name: 'Quoniam Development', customerId: 'quoniam', purchaseOrder: 'PO-2026-006', hourlyRate: 88, budgetHours: 1000 },
  { id: 'wdw-portal', name: 'WDW Kundenportal', customerId: 'westdeutsche', purchaseOrder: 'PO-2026-007', hourlyRate: 85, budgetHours: 800 },
  { id: 'vilano-app', name: 'Vilano App Development', customerId: 'vilano', purchaseOrder: 'PO-2026-008', hourlyRate: 92, budgetHours: 600 },
];

// Customer-Employee assignments
const assignments = [
  { employeeId: 'bartoszewicz', customerId: 'baker', hourlyRate: 95 },
  { employeeId: 'fuss', customerId: 'baker', hourlyRate: 93 },
  { employeeId: 'fittkau', customerId: 'baker', hourlyRate: 95 },
  { employeeId: 'schmidt', customerId: 'baker', hourlyRate: 93 },
  { employeeId: 'nachtigall', customerId: 'baker', hourlyRate: 98 },
  { employeeId: 'xavier', customerId: 'baker', hourlyRate: 93 },
  { employeeId: 'harder', customerId: 'baker', hourlyRate: 85 },
  { employeeId: 'vinkemeier', customerId: 'baker', hourlyRate: 95 },
  { employeeId: 'anderle', customerId: 'diartis', hourlyRate: 90 },
  { employeeId: 'andonov', customerId: 'diartis', hourlyRate: 90 },
  { employeeId: 'froehlich', customerId: 'diartis', hourlyRate: 88 },
  { employeeId: 'hantke', customerId: 'diebold', hourlyRate: 98 },
  { employeeId: 'teschke', customerId: 'diebold', hourlyRate: 95 },
  { employeeId: 'esau', customerId: 'diebold', hourlyRate: 95 },
  { employeeId: 'kamin', customerId: 'diebold', hourlyRate: 98 },
  { employeeId: 'bald', customerId: 'quoniam', hourlyRate: 88 },
  { employeeId: 'mueller', customerId: 'quoniam', hourlyRate: 92 },
  { employeeId: 'weber', customerId: 'quoniam', hourlyRate: 88 },
  { employeeId: 'koch', customerId: 'westdeutsche', hourlyRate: 85 },
  { employeeId: 'braun', customerId: 'westdeutsche', hourlyRate: 82 },
  { employeeId: 'lang', customerId: 'westdeutsche', hourlyRate: 85 },
  { employeeId: 'hoffmann', customerId: 'vilano', hourlyRate: 92 },
  { employeeId: 'richter', customerId: 'vilano', hourlyRate: 85 },
  { employeeId: 'klein', customerId: 'vilano', hourlyRate: 90 },
  { employeeId: 'berger', customerId: 'vilano', hourlyRate: 92 },
  { employeeId: 'wolf', customerId: 'vilano', hourlyRate: 88 },
  { employeeId: 'volkmann', customerId: 'diartis', hourlyRate: 90 },
];
